...
1. [Verb] + [Outcome]
   ...
   → "Design screenshots that convert"

2. [Number] + [Benefit]
   → "50+ metrics at your fingertips"
   → "3x faster app optimization"

3. [Question]
   → "Losing downloads? See why."
   → "Ready to grow?"

4. [Before/After]
   → "From 0 to 10K downloads"
   → "Before ASO vs After ASO"
...
Screen 2: Discovery → "Meet AppBoard — your ASO command center"
Screen 3: Solution → "Track every keyword, every day"
Screen 4: Feature → "Design screenshots that sell"
Screen 5: Result → "Watch your downloads grow"
